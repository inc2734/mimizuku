...
<form role="search" method="get" class="_p-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<div class="_c-input-group">
		<div class="_c-input-group__field">
			<input type="search" placeholder="<?php echo esc_attr_x( 'Search &hellip;', 'placeholder', 'mimizuku' ); ?>" value="<?php echo get_search_query(); ?>" name="s" title="<?php echo esc_attr_x( 'Search for:', 'label', 'mimizuku' ); ?>">
		</div>
